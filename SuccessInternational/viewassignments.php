...
<head>
    <title>SuccessInternational | Student | All Assignments </title>
...
<body onload="loadAllStudentAssignments();">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active d-none d-lg-block">
                            <a class="nav-link" style="text-decoration: underline;">Student | All Assignments <span class="sr-only"></span></a>
                        </li>
                        <li class="nav-item">
