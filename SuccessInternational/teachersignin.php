...
<head>
    <title>Sign In | Teachers | SuccessInternational</title>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-5 mt-5">
                    <div class="row mt-5 mb-5">
                        ...
                        <div class="col-10 offset-1 mt-4">
                            <span class="fs-5 fw-bold fst-italic">Teachers' Sign In Space</span>
                        </div>
                        ...
                        <div class="col-10 offset-1">
                            <div class="row d-grid p-3 pb-1" id="tsigninbtn">
                                <button class="btn btn-dark" onclick="teacherSignIn();">Sign In Now</button>
                            </div>
                            <div class="row d-grid p-3 pb-1 d-none" id="tsigninwithverifybtn">
                                <button class="btn btn-dark" onclick="teacherSignInWithVerification();">Sign In Now</button>
                            </div>
                        </div>
                ...
                <div class="col-12 col-lg-7 d-none d-lg-block">
                    <div class="row">
                        <img src="resources/teachersignin.jpg" width="100%" height="690px" />
                    </div>
                </div>
            </div>
        </div>
