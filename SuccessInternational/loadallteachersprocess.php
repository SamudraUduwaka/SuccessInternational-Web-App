...
<div class="row">
    <div class="col-12">
        ...
        <?php
        $resultset = Database::search("SELECT * FROM `teacher`");
        ...
        ?>
            <div class="row">
                ...
                <?php
                if($dresultset['teacher_image_id']==null){
                    $im = "resources/profileimage.png";
                }else{
                    $image = Database::search("SELECT * FROM `teacher_image` WHERE `id`='".$dresultset['teacher_image_id']."' ");
                ...
                <?php
                    if($dresultset['status_id']==1){
                        ?>
                            <button class="btn btn-warning" onclick="manageTeachers(<?php echo $dresultset['id'] ?>);" id="statusbtn<?php echo $dresultset['id']?>">Deactive</button>
                        <?php
                    }else if($dresultset['status_id']==2){
                        ?>
                            <button class="btn btn-success" onclick="manageTeachers(<?php echo $dresultset['id'] ?>);" id="statusbtn<?php echo $dresultset['id']?>">Active</button>
                        <?php
                    }
                    ?>
                </div>
