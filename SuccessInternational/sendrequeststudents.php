...
<span style=" display: block;">Contact : 0776380882</span>
    ...
    if (!$mail->send()) {
        ...
        Database::iud("INSERT INTO `" . $user_role . "`(`email`,`password`,`verification_code`,`status_id`,`class_id`,`dateadded`) VALUES('" . $user_email . "','" . $password . "','" . $verification_code . "','2','".$class."','" . $date . "')");
