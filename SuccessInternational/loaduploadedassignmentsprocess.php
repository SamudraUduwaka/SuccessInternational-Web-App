...
$r = Database::search("SELECT `subject_has_class_id` FROM `assignmentpdfs` WHERE `teacher_id`='" . $id . "' GROUP BY `subject_has_class_id`");
$nr = $r->num_rows;
            ...
            <div class="accordion-item">
                ...
                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
                    <div class="accordion-body">
                        ...
                        $resultset = Database::search("SELECT * FROM `assignmentpdfs` WHERE `subject_has_class_id`='" . $dr['subject_has_class_id'] . "'");
                        ...
                        ?>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-4 col-lg-2">
                                        <span class="fs-6"><?php echo $dresultset['name']; ?></span>
                                    </div>
                                    <div class="col-7 col-lg-3">
                                    ...
                                    <div class="col-4 col-lg-2">
                                        <span class="fs-6"><?php echo $dresultset['deadline']; ?></span>
                                    </div>
                                    <div class="col-4 col-lg-2">
