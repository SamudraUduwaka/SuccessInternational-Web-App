...
$all = Database::search("SELECT * FROM `student_has_assignmentmark` WHERE `status_id`='2' GROUP BY `assignmentpdfs_id`");
$nall = $all->num_rows;
...
?>
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><button class="btn btn-success" onclick="makeStatusReleasedMR(<?php echo $dall['id'] ?>);" id="sbutn<?php echo $dall['id'] ?>"><i class="bi bi-send-check-fill"></i></button></td>
    ...
    ?>
    <p class="fw-bold">All assignment marks has been released.</p>
<?php
}
